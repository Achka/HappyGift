    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CartServiceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CartId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartServices", x => x.CartServiceId);
                    table.ForeignKey(
                        name: "FK_CartServices_Carts_CartId",
                        column: x => x.CartId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GiftServiceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    GiftId = table.Column<int>(type: "int", nullable: false),
                    GiftId1 = table.Column<long>(type: "bigint", nullable: true),
                    ServiceId = table.Column<int>(type: "int", nullable: false),
                    ServiceId1 = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GiftServices", x => x.GiftServiceId);
                    table.ForeignKey(
